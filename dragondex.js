...
(function initImprovedDragonDex() {
    ...
    function injectStyles() {
        ...
        style.textContent = `
            ...
            #dragon-list.dex-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.dex-card{position:relative;padding:14px;border-radius:19px;background:rgba(255,255,255,.78);border:1px solid rgba(0,0,0,.07);box-shadow:0 8px 20px rgba(0,0,0,.06);overflow:hidden}.dex-card.unknown{filter:saturate(.35)}.dex-card-icon{font-size:42px;text-align:center;margin:3px 0 8px}.dex-card.unknown .dex-card-icon{filter:grayscale(1);opacity:.45}.dex-card h3{margin:0 0 4px;font-size:16px}.dex-meta{display:flex;gap:6px;flex-wrap:wrap;margin:8px 0}.dex-badge{font-size:10px;font-weight:900;padding:5px 7px;border-radius:999px;background:rgba(0,0,0,.06)}.dex-badge.owned{background:rgba(34,197,94,.14);color:#15803d}.dex-rarity-common{background:rgba(148,163,184,.18)}.dex-rarity-uncommon{background:rgba(34,197,94,.14)}.dex-rarity-rare{background:rgba(59,130,246,.14)}.dex-rarity-epic{background:rgba(168,85,247,.14)}.dex-rarity-legendary{background:rgba(245,158,11,.17)}.dex-hint{margin-top:8px;padding:8px;border-radius:11px;background:rgba(124,58,237,.07);font-size:11px;line-height:1.4}.dex-level{margin-top:8px;font-size:11px;font-weight:800}.dex-number{position:absolute;right:10px;top:9px;font-size:10px;opacity:.45;font-weight:900}@media(max-width:390px){#dragon-list.dex-grid{grid-template-columns:1fr}.dex-card{padding:13px}}
        `;
    ...
    function renderImprovedDragonDex() {
        ...
        list.innerHTML = visible.map((dragon, index) => {
            const found = isDiscovered(dragon);
