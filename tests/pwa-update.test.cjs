...
assert(html.includes('dragonart.js?v=12'));
...
assert(html.includes('pwa.js?v=7'));
...
assert(updater.includes('service-worker.js?v=7'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v7'));
