...
assert(html.includes('dragonart.js?v=16'));
...
assert(html.includes('pwa.js?v=11'));
...
assert(updater.includes('service-worker.js?v=11'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v11'));
