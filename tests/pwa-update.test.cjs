...
assert(html.includes('dragonart.js?v=18'));
...
assert(html.includes('pwa.js?v=13'));
...
assert(updater.includes('service-worker.js?v=13'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v13'));
