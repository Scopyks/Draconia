...
assert(html.includes('dragonprofile.js?v=3'));
assert(html.includes('pwa.js?v=3'));
...
assert(updater.includes('service-worker.js?v=3'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v3'));
