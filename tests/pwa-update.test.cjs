...
assert(html.includes('dragonart.js?v=14'));
...
assert(html.includes('pwa.js?v=9'));
...
assert(updater.includes('service-worker.js?v=9'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v9'));
