...
assert(html.includes('dragonart.js?v=17'));
...
assert(html.includes('pwa.js?v=12'));
...
assert(updater.includes('service-worker.js?v=12'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v12'));
