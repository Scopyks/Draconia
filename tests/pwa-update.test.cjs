...
assert(html.includes('dragonart.js?v=13'));
...
assert(html.includes('pwa.js?v=8'));
...
assert(updater.includes('service-worker.js?v=8'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v8'));
