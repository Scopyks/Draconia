...
assert(html.includes('dragonart.js?v=15'));
assert(html.includes('achievements.js?v=4'));
assert(html.includes('dragontitles.js?v=1'));
assert(html.includes('dragoncare.js?v=4'));
assert(html.includes('dragonprofile.js?v=5'));
assert(html.includes('pwa.js?v=10'));
...
assert(updater.includes('service-worker.js?v=10'));
assert(updater.includes('registration.update()'));
assert(updater.includes('visibilitychange'));
assert(worker.includes('draconia-offline-v10'));
